...
const Search: FC<Props> = ({ handleClick = () => {} }) => {
    ...
    return <div className="relative">
        <input type="text" className="min-w-96 w-full max-h-9 rounded-full bg-light-gray border-0 outline-0 pl-5 text-white/75" placeholder="Search..." value={search} onChange={(e) => {
            if(e.target.value === '') {
                handleClick('');
            }
