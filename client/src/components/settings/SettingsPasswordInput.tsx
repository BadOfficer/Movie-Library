...
const SettingsPasswordInput: FC<Props> = ({ initialValue, name, title }) => {
    ...
    return (
        <div className="relative">
            <input type={showPassword ? 'text' : 'password'} name={name} className="text-main p-0 text-dark-gray px-2.5 py-2 min-w-96 rounded-md" placeholder={title} value={inputValue} onChange={handleChangeValue}/>
